...
class GameState:
    def __init__(self, players: list[Player], deck: Deck, curr_card: Card, curr_chips: int = 0, curr_player: int = 0):
    ...
    def __eq__(self, other):
        other: GameState
        return self.players == other.players and self.deck == other.deck and self.curr_card == other.curr_card \
            and self.curr_chips == other.curr_chips and self._curr_player == other._curr_player
